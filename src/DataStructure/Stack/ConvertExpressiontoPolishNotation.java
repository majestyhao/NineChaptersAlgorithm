...
public class ConvertExpressiontoPolishNotation {
    ...
    public ArrayList<String> convertToPN(String[] expression) {
        ...
        ArrayList<String> res = (ArrayList)preOrder(root);
        if (res == null) {
    ...
    private List<String> preOrder(ExpressionTreeNode head) {
        if (head == null) {
            return null;
        }
        ...
        res.add(head.symbol);
        if (head.left != null) {
            res.addAll(preOrder(head.left));
        }
        if (head.right != null) {
            res.addAll(preOrder(head.right));
        }
